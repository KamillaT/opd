...
<body>
	...
	<?php
		...
		while ($row = $result->fetch_array(MYSQLI_ASSOC)) {
			...
			$dict = array($r['memory'] => "Память", $r['effciency'] => "Эффекктивность", $r['oral_skills'] => "Навыки устного выражения",
			$r['prof_vocab'] => "Профессиональный словарный запас", $r['creativity'] => "Креативность (гибкость, дивергенция, беглость мышления)",
			$r['logic'] => "Способность к логическому рассуждению", $r['communication'] =>  "Коммуникабельность",
			$r['time_manag'] => "Тайм-менеджмент");
			ksort($dict);
