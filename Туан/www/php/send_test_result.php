<?php
    ...
    // $conn->query($query_table);
	$query_table = "CREATE TABLE IF NOT EXISTS $table_name (id INT PRIMARY KEY AUTO_INCREMENT, user_id INT NOT NULL, test_id INT NOT NULL, 
                    avg_time VARCHAR(255) NOT NULL, total_time VARCHAR(255) NOT NULL, correct VARCHAR(255) NOT NULL,
    ...
    $conn->query("INSERT INTO $table_name(user_id, test_id, avg_time, total_time, correct, misses, score) 
        VALUES ($user_id, $test_id, '$avg_time', '$total_time', '$correct', '$misses', '$score')");
